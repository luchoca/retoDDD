...
import AgreggatePista.EventsDomainPista.PisteroRemoved;
...
class RemovePisteroUseCaseTest {

    @InjectMocks
    private RemovePisteroUseCase useCase;

    @Mock
    private DomainEventRepository repository;

    @Test
    void removePisteroToPistaSuccessfully() {
        ...
        var command = new RemovePistero(pisteroID,nombre, pistaID);
        ...
        var events = UseCaseHandler.getInstance()
                ...
                .orElseThrow()
                .getDomainEvents();
        var event = (PisteroRemoved) events.get(0);
